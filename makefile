FILES :=								\
    .travis.yml							\
    graph-tests/jhm2464-TestGraph.c++	\
    graph-tests/jhm2464-TestGraph.out	\
    Graph.h 							\
    Graph.log							\
    html								\
    TestGraph.c++						\
...
graph-tests:
	git clone https://github.com/cs378-summer-2015/graph-tests
...
TestGraph.out: TestGraph
	$(VALGRIND) --track-origins=yes ./TestGraph  >  TestGraph.out 2>&1
